...
let videoOnlyBtn  = document.getElementById('videoOnly'),
    ...
    <ul class="bs-iframes">
        <li class="active">
    <iframe allow="encrypted-media" allowfullscreen="" frameborder="0" height="250" sandbox="allow-scripts allow-same-origin allow-forms" src="Url do vide aqui" width="100%"></iframe>
        </li>
        <li>
      <iframe allow="encrypted-media" allowfullscreen="" frameborder="0" height="250" sandbox="allow-scripts allow-same-origin allow-forms" src="Url do vide aqui" width="100%"></iframe>
        </li>
