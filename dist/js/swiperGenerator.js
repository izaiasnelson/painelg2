...
<div class="swiper-slide">
    <div class="bs-card">
        ...
        <div class="card-content">
            ...
            <div>
                <a class="btn btn-blur" href="#"><i class="fa-solid fa-play" /> Assistir</a>
            </div>
        </div>
    </div>
</div>
...
`;
        ...
        if(isMovie.checked){
            ...
            const respuesta = await fetch(`https://api.themoviedb.org/3/movie/${serieKey}?api_key=6f6904c140e654b8086b57ad05687fa8&language=pt-BR{languaje}`);
