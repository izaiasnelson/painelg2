    ...
    const cargarPeliculas = async() => {
        ...
        if (isSerie.checked) {
            try {
                ...
                const respuesta = await fetch(`https://api.themoviedb.org/3/tv/${serieKey}?api_key=6f6904c140e654b8086b57ad05687fa8&language=pt-BR{languaje}`);
                const respuesta3 = await fetch(`https://api.themoviedb.org/3/tv/${serieKey}/season/${seasonNumber}?api_key=6f6904c140e654b8086b57ad05687fa8&language=pt-BR{languaje}`);
...
<div class="fav-js">
<button class="bs-favs" card-id="${datos.id}" id="add-btn"><i class="fa-regular fa-heart"></i> Salvar na Lista</button>
<button class="delete-btn none-btn" card-id="${datos.id}" id="remove-btn"><i class="fa-solid fa-trash"></i>Remove da Lista</button>
</div>
</div>
...
<div class="bs-video-player">
    <ul class="player-options">
        <li class="active">Dublado</li>
        <li>Legendado</li>
    </ul>
    <ul class="bs-iframes">
        <li class="active"><iframe allow="encrypted-media" allowfullscreen="" frameborder="0" height="250" sandbox="allow-scripts allow-same-origin allow-forms" src="Url do vide aqui" width="100%"></iframe></li>
        <li><iframe allow="encrypted-media" allowfullscreen="" frameborder="0" height="250" sandbox="allow-scripts allow-same-origin allow-forms" src="Url do vide aqui" width="100%"></iframe></li>
    </ul>
